...
const MovieDetail = () => {
  ...
  const DetailInfo = () => {
    ...
    const actors = Array.isArray(selectedMovie.actors) ? selectedMovie.actors : [];
    const reviews = Array.isArray(selectedMovie.reviews) ? selectedMovie.reviews : [];
    const avgRating = selectedMovie.avgRating ?? 0;
